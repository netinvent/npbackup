...
def test_uri_parsing():
    repos = {
        ...
        "s3:https://rustfs.local/mybucket/myrepo": {
            "backend_type": "s3",
            "endpoint": "rustfs.local",
            "bucket": "mybucket",
            "path": "myrepo",
            "port": None,
            "scheme": "https",
        },
        "s3:https://some.long.domain.tld:443/isabel-prod": {
            "backend_type": "s3",
            "endpoint": "some.long.domain.tld",
            "port": 443,
            "bucket": "isabel-prod",
            "path": None,
            "scheme": "https",
        },
        "s3:http://rustfs.local/mybucket/myrepo": {
            "backend_type": "s3",
            "endpoint": "rustfs.local",
            "port": None,
            "bucket": "mybucket",
